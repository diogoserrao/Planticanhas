            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0 fade-in" data-delay="200">
                    <div class="position-relative">
                        ...
                        <div class="position-absolute top-0 start-0 translate-middle bg-success text-white p-3 rounded-circle" style="width: 120px; height: 120px; display: flex !important; align-items: center; justify-content: center;">
