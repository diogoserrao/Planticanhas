        ...
        <form action="{{ route('banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    @enderror
                    <div class="form-help-text">Posição de exibição no carrossel (menor número = primeiro)</div>
                </div>
                ...
                <div class="col-12 mb-4">
                    ...
                    <div class="mb-3">
                        @if(Str::startsWith($banner->image, 'http') || Str::startsWith($banner->image, '/'))
                            <img src="{{ $banner->image }}" alt="Banner atual" class="img-thumbnail banner-preview">
                        @else
                            <img src="{{ asset('storage/' . $banner->image) }}" alt="Banner atual" class="img-thumbnail banner-preview">
                        @endif
